...
<html lang="en" data-theme="light"  data-sidebar-behaviour="fixed" data-navigation-color="inverted" data-is-fluid="true">
    <head>
        ...
        <!-- Favicon -->
        <link rel="icon" href="{{ URL::asset('assets/favicon/favicon.ico') }}" sizes="any">
                ...
                <div class="collapse navbar-collapse" id="sidenavCollapse">
                    ...
                    <ul class="navbar-nav mb-lg-7">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link " href="index.html#pagesCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="pagesCollapse">
        ...
        <main>
            ...
            <header class="container-fluid d-flex py-6 mb-4">
                ...
                <div class="d-flex align-items-center ms-auto me-n1 me-lg-n2">
                    ...
                    <!-- Button -->
                    <a class="d-flex align-items-center justify-content-center bg-white rounded-circle shadow-sm mx-1 mx-lg-2 w-40px h-40px link-secondary" data-bs-toggle="offcanvas" href="index.html#offcanvasCustomize" role="button" aria-controls="offcanvasCustomize">
